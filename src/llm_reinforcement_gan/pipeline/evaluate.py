...
class Evaluate(pydantic.BaseModel):
    ...
    def __call__(self, source: typing.List[str], target: typing.List[str]) -> typing.Tuple[pandas.Series, pandas.DataFrame]:
        ...
        return Evaluate._calculate_corr(clss_src, clss_tgt), Evaluate._calculate_mae(clss_src, clss_tgt)

    @staticmethod 
    def _calculate_corr(clss_src: pandas.DataFrame, clss_tgt: pandas.DataFrame, method: str = "pearson") -> pandas.Series:
    ...
    @staticmethod
    def _calculate_mae(clss_src: pandas.DataFrame, clss_tgt: pandas.DataFrame) -> pandas.DataFrame:
        return (
            (clss_src - clss_tgt).abs()
            .T
            .agg(["mean", "std"], axis=1)
